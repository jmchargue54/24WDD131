...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardContainer = document.querySelector("cardnumholder");
    const paypalContainer = document.querySelector("#paypalholder");
    ...
    // theForm.["paypal-user"].required = false;  
