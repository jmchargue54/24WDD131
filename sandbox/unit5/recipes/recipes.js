...
console.log(getEntry(recipes));

function recipeTemplate(recipe) {
	return `
		<section class="recipe">
			<img id="recipeImg" src= ${recipe.image} alt="recipe image" loading="lazy"/>
			<div class="info">
...
document.querySelector('#searchImg').addEventListener('click', searchHandler);
